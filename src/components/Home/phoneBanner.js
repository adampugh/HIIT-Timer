        ...
        <div className="container">
            <div className="phoneBanner__grid">
                ...
                <div className="phoneBanner__grid__panel">
                    <h3>High-intensity interval-training (HIIT) workouts are designed to build muscle and burn fat in a short period of time. Research has shown that HIIT regimens have successfully produced significant reductions in the fat mass of the whole-body.</h3>
